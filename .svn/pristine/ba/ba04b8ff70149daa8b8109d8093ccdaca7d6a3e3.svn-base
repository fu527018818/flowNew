            ...
            <div>
             ...
             <div class="impressionBox mline">
              ...
              <div class="mpd twoFont">
                <el-form-item label="姓名" prop="real_name" class="wh_350">
                    <el-input v-model.number="ruleForm.real_name"></el-input>
                </el-form-item>
              </div>
              <div class="twoFont">
                <el-form-item label="性别" prop="gender" class="wh_350">
                    <el-input v-model.number="ruleForm.gender"></el-input>
                </el-form-item>
              </div>
              <div class="twoFont">
                <el-form-item label="年龄" prop="age" class="wh_350">
              ...
              <div class="twoFont">
               ...
               <div class="twoFont">
                ...
                <div class="moreFont mline">
                    <el-form-item label="收银系统会员号" prop="customer_no" label-width="120px">
                        <el-input class="wh_200" v-model="ruleForm.customer_no"></el-input>
                        <el-button type="primary" @click="customerEvent()">点击绑定</el-button>
                    </el-form-item>
                </div>
                <div class="brandBox mline">
                    ...
                    <el-row class="brand">
                        <el-col :span="4"  class="brand_list" v-for="(item,index) in ruleForm.favorite_brand" :key="item.id">
                ...
                <!-- <div class="fourFont">
                    <el-form-item label="地址详情" prop="address" class="wh_350">
                        <el-input type="textarea" :rows="4" v-model.number="ruleForm.address"></el-input>
                    </el-form-item>
                </div> -->
                <div class="twoFont">
...
<script>
    ...
    import {getCity,getBrandList,userEditData,setPospalUser} from '../../../api/global';
    ...
    export default {
        ...
        methods:{
            ...
            onSubmitEdit(formName){
               this.$refs[formName].validate((valid)=>{
                   if(valid){
                    ...
                    //当为陌生客时传给后台的为空值
                     if(this.ruleForm.real_name =="陌生客"&&!this.ruleForm.real_name==""){
            ...
            customerEvent(){
                //绑定会员号
                setPospalUser({menber_id:this.currentInfo.id,customer_num:this.ruleForm.customer_no}).then(data=>{
        ...
        created(){
            ...
            getBrandList({}).then(res=>{
               if(res.data.status=="200"){
                    this.brandList = res.data.data.lists;
               }
            })
            if(this.currentInfo){
                this.userEditInit()
