          ...
          <div class="menuBox"  v-show="isMenu">
              ...
              <el-submenu index="/statistics" class="itemDown">
               ...
               <el-submenu index="/software" class="itemDown">
                  ...
                  <el-menu-item index="/software/intrusiveWarning">侵入警告</el-menu-item>
              </el-submenu>
            ...
            <!-- 导航菜单 start right-->
              <el-menu
                ...
                <el-submenu  index="userHead"  class="user-img">
                      ...
                      <el-menu-item index="/photoAlbum">我的相册</el-menu-item>
    ...
    menuType(index){
      ...
      switch(index){
        ...
        this.activeIndex = "/software";
         case "/software/intrusiveWarning":
        this.activeIndex = "/software/intrusiveWarning";
        break;
        case "/message":
        ...
        break;
        case "/photoAlbum":
            this.activeIndex = "/photoAlbum";
            this.$router.push({name:"photoAlbumPicture"}); 
        break;
        case "/selectShop":
