                            ...
                            <div class="warnTit">
                                ...
                                <el-row  class="bindBox">
                                    ...
                                    <el-col :span="9" class="passBtn">
                                        <span class="passtext">{{item.status==1?'已通过':'不通过'}}</span>
                                        <!-- <div>
...
<style scoped lang="scss">
    ...
    .warnContent{
      ...
      .bindBox{
          padding-bottom:30px;
          & .passBtn{
              .passtext{display: block;text-align: right;padding: 20px;color:#808080;}
              text-align: right;
              & .el-button--primary{
