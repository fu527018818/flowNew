<template>
    <div class="detailLeft" v-if="currentInfo">
        ...
        <div class="userDesc">
            {{currentInfo.short_info|defaultNot}}
        </div>
        <!-- 评星 -->
        ...
        <ul class="basicDetails">
            ...
            <li>
                <el-row>
                    ...
                    <el-col :span="16" class="listRight" v-if ="isIphone" :style="'color:'+formatPhone||'#4198ff'+';height:54px'">
            ...
            <li>
                 <el-row>
                    ...
                    <el-col :span="16" class="listRight">
                        {{currentInfo.shoe_size|defaultNot}}
                    </el-col>
                </el-row>
            </li>
            <li >
