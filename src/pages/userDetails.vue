                ...
                <div class="userDetailBox">
                    <el-row class="userDetail">
                        ...
                        <el-col :span="9" class="userDetailLeft">
                            <datail-left @showBigHeader="showBigHeaderEvent" ref="changeLeftInfo"></datail-left>
                        </el-col>
                        <!-- 详情左侧 end -->
                        <!-- 详情右侧  start-->
                        <el-col :span="15" class="userDetailRight">
                            <div class="rightBox">
                                <div class="rightMenu clearfix">  
                                    <!-- 切换路由 -->
                                    <el-col :span="8" @click.native="changeMenu('userDetailsInfo')"  :class="['tabItem',{active:is_menus=='userDetailsInfo'}]">客户信息</el-col>  
                                    <el-col :span="8" @click.native="changeMenu('userDetailsConsume')" :class="['tabItem',{active:is_menus=='userDetailsConsume'}]">消费记录</el-col>  
                                    <el-col :span="8" @click.native="changeMenu('userDetailsServe')" :class="['tabItem',{active:is_menus=='userDetailsServe'}]">到店记录</el-col>  
                                    <!-- <el-radio-group id="userCut" v-model="is_menus" @change="changeMenu">
                                        <el-radio-button class="tabItem" label="userDetailsInfo">客户信息</el-radio-button>
                                        <el-radio-button class="tabItem" label="userDetailsConsume">消费记录</el-radio-button>
                                        <el-radio-button class="tabItem" label="userDetailsServe">到店记录</el-radio-button>
...
export default {
  ...
  methods: {
    ...
    goto(id){
        this.$refs.changeEditr.isIphone = true;
        this.$refs.changeLeftInfo.isIphone = true;
