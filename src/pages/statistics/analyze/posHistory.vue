        ...
        <div class="contentBox" v-slim-scroll>
            <div class="contentBox_child">
                <div class="content">
                        ...
                        <div slot="searchList">
                         ...
                         <div class="conditionTag" slot="conditionTag">
                             <el-tag 
                                ...
                                >
                                录入时间：<span >{{date1[0]+'至'+date1[1]}}</span>    
                            </el-tag><el-tag 
                                type="info"
                                :disable-transitions="false"
                                >
                                成交时间：<span >{{date2[0]+'至'+date2[1]}}</span>    
                            </el-tag><el-tag 
                                type="info"
                                :disable-transitions="false"
                                v-if="type.length>0"
                    ...
                    <pos-history-table ref="historytable" :lists="lists"></pos-history-table>
                </div>
  ...
  methods:{ //改变分页
   ...
   posInit(val){
       if(this.$refs.historytable){
            this.$refs.historytable.loading = true;
        }
      statisticsPosList({
      ...
      .then(res=>{
           ...
           setTimeout(()=>{if(this.$refs.historytable){
                this.$refs.historytable.loading = false;
            }},500);
      },err=>{
          setTimeout(()=>{if(this.$refs.historytable){
                this.$refs.historytable.loading = false;
