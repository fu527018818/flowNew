        ...
        <div class="contentBox" v-slim-scroll>
            <div class="contentBox_child">
                <div class="content">
                        ...
                        <div slot="searchList">
                         ...
                         <div class="conditionTag" slot="conditionTag">
                             <el-tag 
                                ...
                                >
                                录入时间：<span >{{date1[0]+ '至'+date2[1]}}</span>    
                            </el-tag><el-tag 
                                type="info"
                                :disable-transitions="false"
                                >
                                支出时间：<span >{{date2[0]+ '至'+date2[1]}}</span>    
                            </el-tag><el-tag 
                                type="info"
                                :disable-transitions="false"
                                v-if="type.length>0"
                    ...
                    <expenditures-table ref="expenditurestable" :lists="lists"></expenditures-table>
                </div>
...
export default {
  ...
  methods:{
   ...
   expendituresInit(val){
       ...
       if(this.$refs.expenditurestable){
            this.$refs.expenditurestable.loading = true;
        }
         ...
         .then(res=>{
               ...
               setTimeout(()=>{if(this.$refs.expenditurestable){
                this.$refs.expenditurestable.loading = false;
            }},500);
        },err=>{
            setTimeout(()=>{if(this.$refs.expenditurestable){
                    this.$refs.expenditurestable.loading = false;
