                    ...
                    <div class="trendChartBox">
                        ...
                        <div id="turnoverCut">
                            <el-radio-group v-model="cut_trend_chart" @change="cutChange">
                                ...
                                <el-radio-button label="return_member_rate">回头客贡献</el-radio-button>
                            </el-radio-group>
                        </div>
...
export default {
        ...
        methods:{
            ...
            seachtrigger(val){
                ...
                statisticsTurnover({
                    ...
                    if (this.chart.joint_rate) {
                        //清除连带率
                        delete this.chart.joint_rate;
                    }
    ...
    circle(data){
        ...
        penetrate(item){
                switch(item.name){
                    case '营业额':
                    this.$router.push({name:'statisticsIndent',params:{date:this.date,type:item.name}})
                    break;
                    case '客流量':
                    this.$router.push({name:'passengerFlow',params:{date:this.date,type:item.name}})
                    break;
                    case '成交量':
                    this.$router.push({name:'statisticsIndent',params:{date:this.date,type:item.name}})
                    break;
                    case '成交率':
                    this.$router.push({name:'statisticsRefer',params:{date:this.date,type:item.name}})
                    break;
                    case '客单价':
                    this.$router.push({name:'statisticsRefer',params:{date:this.date,type:item.name}})
                    break;
