...
import software from '../pages/software/software.vue';
import recording from '../pages/software/recording.vue';
...
import InterFace from '../pages/sets/interFace.vue';
import editInterFace from '../pages/sets/editInterFace.vue';
...
import noticeCeshi from '../pages/sets/noticeCeshi.vue';
import intrusiveWarning from '../pages/software/intrusiveWarning.vue';
import photoAlbum from '../pages/software/photoAlbum.vue';
Vue.use(Router)
/* 异步加载组件模块 */
...
export const constantRouterMap = [
  ...
  {
    path: "/software/recording",
    name: "recording",
    component: recording
  },
  {
    path: "/software/intrusiveWarning",
    name: "intrusiveWarning",
    component: intrusiveWarning
  },
  {
    path: "/software/photoAlbum",
    name: "photoAlbum",
    component: photoAlbum,
    children:[
      { path: "/photoAlbum/picture", name:"photoAlbumPicture", component: _import('components/softWare/picture') },
      { path: "/photoAlbum/recording", name:"photoAlbumRecording", component: _import('components/softWare/recording') },
    ]
  },
  {
    path: "/dataEnter",
